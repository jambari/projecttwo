...
return [
    ...
    */
    ...
    'project_name' => 'Sistem Pengambilan Keputusan',
    ...
    'project_logo'   => '<img src="/images/logo-pdam.png" wide="40px" height="35px" alt="company-logo" />',
    ...
    'body_class' => 'app aside-menu-fixed sidebar-lg-show text-dark ',
